...
Что делает:
  ...
  2. Прогоняет НАСТОЯЩИЙ конвейер из src/sanas/door_apc.py (то же 60-град.
     ...
     paper/results/apc_validation.json и при расхождении скрипт падает.
...
Запуск из корня репозитория или откуда угодно:
  python docs/pitch/demo/make_demo_animation.py
...
VALIDATION_JSON = REPO / "paper" / "results" / "apc_validation.json"
OUT_DIR = REPO / "docs" / "pitch" / "demo"
...
def run_pipeline() -> dict:
    ...
    # Сверка с paper/results/apc_validation.json: события должны совпасть
