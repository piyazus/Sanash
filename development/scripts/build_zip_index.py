...
Usage:
    python development/scripts/build_zip_index.py
    python development/scripts/build_zip_index.py --mirror zenodo --out data/index/idx.json
    python development/scripts/build_zip_index.py --summary-only     # no write, just report
