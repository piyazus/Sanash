...
- **Sensor:** VL53L7CX, 8×8 = 64 ranging zones, FoV 60°×60° square
  ...
  research/trade_study.md (was ASSUMED 60° diagonal in the first draft)
...
ST documentation via research/trade_study.md); H_ceil and head height remain
...
Measured cross-check (development/experiments/log.md 2026-08-10, counting-band
...
development/experiments/log.md 2026-08-10). With a vertical boresight the node must
...
- The crossing algorithm stays updatable centrally — one gateway deployment
  ...
  motivated `development/scripts/build_kernels.py` (log 2026-08-10).
...
TBD (research/trade_study.md unless noted): VL53L7CX max ranging rate, I²C
