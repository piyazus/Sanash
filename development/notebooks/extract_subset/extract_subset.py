...
The frame selection lives in development/src/sanas/selection.py and is shared with the
depth kernels, so every run picks frames the same way.

DO NOT EDIT the generated block below. Edit development/src/sanas/ and run
`python development/scripts/build_kernels.py`.
"""
