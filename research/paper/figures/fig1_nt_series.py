...
Spec: research/paper/figures.md, Fig. 1 section (final, 2026-08-10); semantics per the
JSON `definitions` block, which is authoritative. Data:
research/paper/results/apc_validation.json only; all five series plotted as-is (no
