...
Spec: research/paper/figures.md, Fig. 3 section (2026-08-10 update: reference line at
0.7 m, +/-0.35 m head-height strip, 60x60 deg FoV confirmed - see
development/hardware/node_design.md). Data: research/paper/results/apc_validation.json
