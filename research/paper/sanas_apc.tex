...
% completed results only (development/experiments/log.md, development/findings.md,
% research/trade_study.md, research/paper/results/apc_validation.{md,json}).
%
% FIGURES: built by CADy to the specification in research/paper/figures.md.
% Result plots (Figs. 1-3) are generated from research/paper/results/apc_validation.json.
% Hardware figures (Figs. 4-7) are PDF exports of the existing SVGs in
% development/hardware/figures/. Do not renumber figures without updating figures.md.
%
...
\usepackage{cite}
% Figure PDFs are in research/paper/figures/ (built by CADy per research/paper/figures.md).
\usepackage{graphicx}
\usepackage{array}
\usepackage{booktabs}
\usepackage{url}
...
\begin{figure}[t]
\centering
% CADy: export development/hardware/figures/system_architecture.svg to PDF.
...
\begin{figure*}[t]
\centering
% CADy: export development/hardware/figures/sensor_placement.svg to PDF.
...
\begin{figure*}[t]
\centering
% CADy: export development/hardware/figures/wiring_schematic.svg to PDF.
...
\begin{figure*}[t]
\centering
% CADy: export development/hardware/figures/dataflow.svg to PDF.
