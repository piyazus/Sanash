# Figure specification — Sanas APC paper (`research/paper/sanas_apc.tex`)
...
2. Result plots (Figs. 1-3) are generated **only** from
   `research/paper/results/apc_validation.json`. No numbers from anywhere else, no
...
4. Output files go to `research/paper/figures/` with the exact filenames below
...
- File: `research/paper/figures/fig1_nt_series.pdf`
...
- File: `research/paper/figures/fig2_resolution_ablation.pdf`
...
- File: `research/paper/figures/fig3_band_sweep.pdf`
- Placement: single column, referenced in Sec. VI.
...
- Annotations:
  - vertical reference line at x = 0.7 m labelled to the effect of
    ...
    diagonal, see development/hardware/node_design.md — the earlier ±0.25 m at
...
|---|---|---|---|---|
| Fig. 4 | H1 | `development/hardware/figures/system_architecture.svg` | `research/paper/figures/fig4_system_architecture.pdf` | single column |
| Fig. 5 | H2 | `development/hardware/figures/sensor_placement.svg` | `research/paper/figures/fig5_sensor_placement.pdf` | double column |
| Fig. 6 | H3 | `development/hardware/figures/wiring_schematic.svg` | `research/paper/figures/fig6_wiring_schematic.pdf` | double column |
| Fig. 7 | H4 | `development/hardware/figures/dataflow.svg` | `research/paper/figures/fig7_dataflow.pdf` | double column |
...
H1-H4 caption text in `development/hardware/*.md` for the paper only — the hardware
docs keep their own):
